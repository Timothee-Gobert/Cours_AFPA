...
<body>
    ...
    <div class="container-fluid my-4">
        <nav class="navbar navbar-expand-md bg-dark text-light fixed-top rounded-bottom">
            ...
            <div id="nav" class="collapse navbar-collapse justify-content-between">
                <ul class="navbar-nav px-2">
                    <li class="nav-item"><a href="index.php" class="nav-link text-light fw-bold">Acceuil</a></li>
                    ...
                    <li class="nav-item dropdown"><a href="" class="nav-link text-light fw-bold dropdown-toggle"
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item dropdown-item"><a href="" class="nav-link">Facture</a></li>
                            <li class="nav-item dropend dropdown-item">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="nav-item dropdown-item"><a href="" class="nav-link">Domicile</a></li>
                                    <li class="nav-item dropdown-item"><a href="" class="nav-link">Magasin</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                ...
                <form action="">
                    <div class="input-group">
                        <input type="text" class="form-control mx-2" placeholder="Mot à chercher">
                        <a href="" class="btn bg-light rounded-end"><i class="fa fa-search"></i></a>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item"><a href="" class="nav-link"></a>Changement mot de passe</li>
        ...
        <div class="row">
            <div id="aside-left" class="col-md-3 bg-info">
            </div>
            <div id="section-bs" class="col-md-9 bg-success">
                <?=$content?>
        ...
        <footer class="my-4">
            <div class="row bg-dark justify-content-center">
                ...
                <div class="col-sm-3 col-md-3 col-lg-3 text-light">
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi officiis quisquam voluptatem
                        tempore consectetur vel eos aut ipsam amet dolore fugit iusto tenetur, quo rem dignissimos
